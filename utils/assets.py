...
class ASSETS:
    ...
    SpeedUp = "speedup.png"
    RuneLevel = "runelevel.png"
    RuneType = "runetype.png"
    RuneDrop = "runedrop.png"
    RuneLevel1 = "runelevel1.png"
    RuneLevel2 = "runelevel2.png"
    RuneLevel3 = "runelevel3.png"
    RuneLevel4 = "runelevel4.png"
    RuneLevel5 = "runelevel5.png"
    RuneGold = "runegold.png"
    RuneLife = "runelife.png"
    RuneSpeed = "runespeed.png"
    RuneCollect = "runecollect.png"
    RuneStamina = "runestamina.png"
    RuneStrength = "runestrength.png"

# Rune level to asset mapping
RUNE_LEVEL_TO_ASSET = {
    1: ASSETS.RuneLevel1,
    2: ASSETS.RuneLevel2,
    3: ASSETS.RuneLevel3,
...
RUNE_TYPE_TO_ASSET = {
    ...
    "Strength": ASSETS.RuneStrength,
    "Stamina": ASSETS.RuneStamina,
    "Speed": ASSETS.RuneSpeed,
    "Gold": ASSETS.RuneGold,
}

# Rune types for dynamic lookup
RUNE_TYPES_LIST = ["life", "strength", "stamina", "speed", "gold"]

def get_rune_asset(level: int, rune_type: str, team: bool) -> str:
    """Get rune asset filename dynamically: rune{level}{type}{s/t}.png"""
    suffix = "t" if team else "s"
    return f"rune{level}{rune_type.lower()}{suffix}.png"
